                            ...
                            <?php else: ?>
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="detail.php?id=<?php echo $user['user_id']; ?>" class="btn-icon" title="Detail">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="edit.php?id=<?php echo $user['user_id']; ?>" class="btn-icon" title="Edit">
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', (e) => {
                ...
                confirmDelete.href = `index.php?delete=${userId}`;
