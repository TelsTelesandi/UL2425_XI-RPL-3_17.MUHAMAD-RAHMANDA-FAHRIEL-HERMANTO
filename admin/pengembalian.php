...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_return'])) {
    ...
    $updateStmt->bind_param("ssi", $status, $admin_notes, $bookingId);
                            ...
                            <?php else: ?>
                                <?php foreach ($returnRequests as $request): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $request['nama_lengkap']; ?></td>
                                        <td><?php echo $request['nama_ruangan']; ?></td>
                                        ...
                                        <td><?php echo $request['return_condition']; ?></td>
                                        <td>
